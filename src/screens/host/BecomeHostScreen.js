  ...
  const onboardingSteps = [
    {
      ...
      description: 'Turn your extra space into extra income. List your property on Qatar\'s premier rental platform.',
    ...
    },
    {
      ...
      description: 'Our Host Protection Program and 24/7 support give you peace of mind when hosting in Qatar.',
    ...
    },
    {
      ...
      description: 'Create your listing for free. Only pay when you start earning from successful bookings.',
      image: 'https://images.unsplash.com/photo-1580041065738-e72023775cdc?w=400&h=300&fit=crop',
      icon: '✨',
    },
  ];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.earningsPreview}>
        <Text style={styles.earningsTitle}>
          Qatar hosts earn an average of
        </Text>
