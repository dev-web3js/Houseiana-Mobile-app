      ...
      case 'confirm':
        Alert.alert(
          ...
          [
            ...
            {text: 'Confirm', onPress: () => updateBookingStatus(booking.id, 'confirmed')}
          ]
        );
        break;
      case 'cancel':
        Alert.alert(
          ...
          [
            ...
            {text: 'Yes', style: 'destructive', onPress: () => updateBookingStatus(booking.id, 'cancelled')}
          ]
        );
        break;
      case 'contact':
    ...
    switch (activeTab) {
      ...
      case 'current':
        return bookings.filter(booking => 
          new Date(booking.checkIn) <= now && new Date(booking.checkOut) >= now
        );
      case 'past':
    ...
    <View key={booking.id} style={styles.bookingCard}>
      ...
      <View style={styles.bookingDetails}>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailText}>Booked: {formatDate(booking.bookingDate)}</Text>
        </View>
      </View>
